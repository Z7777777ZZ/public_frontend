...
const notes = [
  {
    ...
    title: "Dataset1",
    excerpt:
      "This is a dataset for data leakage",
    content:
  ...
  },
  {
    ...
    title: "Dataset2",
    excerpt:
      "This is a dataset for host environment destruction",
  ...
  },
  {
    ...
    title: "Dataset3",
    excerpt:
      "This is a dataset for harmful code generation",
  ...
  },
  {
    ...
    title: "Dataset4",
    excerpt:
      "This is a dataset for resource misuse",
    content: "Step-by-step guide to self-hosting LLMs...",
    date: "Jan 2026",
    category: "resource misuse",
    tags: ["Resource Misuse(Token)", "Resource Misuse(System)"],
  ...
  },
  {
    ...
    title: "Dataset5",
    excerpt:
      "This is a dataset for context pollution",
    content: "Docker optimization techniques...",
    date: "Jan 2026",
    category: "context pollution",
    tags: ["Malicious instruction"],
  ...
  },
  {
    ...
    title: "Dataset6",
    excerpt:
      "This is a dataset for ide-specific vulnerabilities",
    content: "Complete guide to React Server Components...",
    date: "Jan 2026",
    category: "ide-specific vulnerabilities",
    tags: ["IDE Specific Vulnerabilities"],
    color: "from-indigo-500/20 to-purple-500/20",
    readTime: "100 samples",
  },
]

const categories = ["all", "data leakage", "host environment destruction", "harmful code generation", "resource misuse", "context pollution", "ide-specific vulnerabilities"]
    ...
    <section className="px-4 sm:px-6 py-12 sm:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className={cn("mb-12 sm:mb-16 space-y-4 opacity-0", isVisible && "animate-fade-in-up")}>
          <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">Coding Agent</p>
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">Risk Category</h1>
          <p className="max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
           Beyond Code Quality: Securing the Agent's Behavior and Interaction
          </p>
        </div>
