...
// 数据集信息
const datasetInfo: Record<string, { title: string; category: string; description: string }> = {
  "1": {
      ...
      code: `# Data received by attacker's server
{
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Analysis Cards */}
      <div className="grid md:grid-cols-3 gap-4 mt-12 pt-12 border-t border-border/30">
